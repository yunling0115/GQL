...
public class populate {
    ...
    public static void main(String[] args) {
    	...
    	// set default files
    	String bfile = "buildings.xy";
    	String sfile = "students.xy";
    	String asfile = "announcementSystems.xy";
    	// modify files according arguments
    	if (length>=1) {bfile=args[0];}
    	if (length>=2) {sfile=args[1];}
    	if (length>=3) {asfile=args[2];}
    	System.out.println(bfile);
    	System.out.println(sfile);
    	System.out.println(asfile);
    	System.out.println();
    	populate e = new populate(bfile,sfile,asfile);
        System.out.println();   	
    }
    
    /*****************************/
    public populate(String bfile, String sfile, String asfile)
    {
        ConnectToDB();			// connect to DB

        PublishBuildings(bfile);			
        PublishStudents(sfile);
        PublishAS(asfile);

    }
    
    /*****************************/
    public void PublishBuildings(String bfile) {
    	...
    	try
        {
	    	...
	    	/* Read buildings.xy */
	    	File file1 = new File("data/"+bfile);
    ...
    public void PublishStudents(String sfile) {
    	...
    	try
        {
	        ...
	        /* Read students.xy */
	    	File file2 = new File("data/"+sfile);
    ...
    public void PublishAS(String asfile) {
    	...
    	try
        {
	        ...
	        /* Read AS.xy */
	    	File file3 = new File("data/"+asfile);
    ...
    public void ConnectToDB()
    {
		try
		{
	    	...
	    	String URL = "jdbc:oracle:thin:@localhost:1521:yling"; // office computer
			//String URL = "jdbc:oracle:thin:@localhost:1521:orcl"; // home computer
